package com.proxy.proxyee.intercept.common;

import com.proxy.proxyee.crt.CertUtil;
import com.proxy.proxyee.intercept.HttpProxyIntercept;
import com.proxy.proxyee.intercept.HttpProxyInterceptPipeline;
import com.proxy.proxyee.server.HttpProxyCACertFactory;
...
public class CertDownIntercept extends HttpProxyIntercept {
     ...
     *
     * @param certFactory The same factory as {@link HttpProxyServer}
     *                    ({@link HttpProxyServer#caCertFactory(HttpProxyCACertFactory)})
